...
3D acceleration requires the official VMware SVGA display drivers to be installed in the guest. These drivers use the VMware backdoor interface, which must be enabled in the host KVM module:
